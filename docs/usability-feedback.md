# Preliminary usability feedback and response

Source: one feedback report supplied by the project author in conversation on 24 September 2026, following a planned friend review. No recording, timings, task-by-task completion data, participant background or device information were supplied. Treat the observations as reported feedback, not an independently observed study.

- Empty review queue could overshadow 48 unassessable records: show outside / unassessable / within-envelope counts together in the hero and immediately beside the queue, with a direct link to further assessment.
- 90% target and 97% observed coverage could be confused with accuracy or safety: explain target coverage at the slider; put observed coverage in the method section and define its denominator, including overly wide intervals.
